...
class EditTabForm(forms.Form):
    ...
    text=forms.CharField(widget=forms.Textarea(attrs={'id':'myArea2','rows':40,'cols':50}), help_text='Contents of the tab (html content is permitted - For this, first turn rich text formatting OFF)')
